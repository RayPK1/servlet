...
<body>
	...
	%>
	<%
	String MaSP = request.getParameter("MaSP") == null ? p.getMaSP() : request.getParameter("MaSP");
	%>
	<%
	String TenSP = request.getParameter("TenSP") == null ? p.getTenSP() : request.getParameter("TenSP");
	%>
	<%
	String SoLuong = request.getParameter("SoLuong") == null
			? Integer.toString(p.getSoLuong())
			: request.getParameter("SoLuong");
	%>
	<%
	String DonGia = request.getParameter("DonGia") == null
			? Double.toString(p.getDonGia())
			: request.getParameter("DonGia");
	%>
	<%
	String HinhAnh = request.getParameter("HinhAnh") == null ? p.getHinhAnh() : request.getParameter("HinhAnh");
	%>
	<%
	String DonViTinh = request.getParameter("DonViTinh") == null ? p.getDonViTinh() : request.getParameter("HinhAnh");
	%>
	...
	<div class="container mt-3">
		<div class="row">
			...
			<form action="ModifyProductServlet" method="post">
				<div class="col-9 m-3">
					<div class="row">
						<label for="MaSP" class="col-2 offset-1 col-form-label fw-bold">
							Mã sản phẩm </label>
						<div class="col-9">
							<input type="text" name="MaSP" class="form-control"
								disabled="disabled" value="<%=MaSP%>">
				...
				<div class="col-9 m-3">
					<div class="row">
						<label for="TenSP" class="col-2 offset-1 col-form-label fw-bold">
							Tên sản phẩm </label>
						<div class="col-9">
				...
				<div class="col-9 m-3">
					<div class="row">
						<label for="SoLuong" class="col-2 offset-1 col-form-label fw-bold">
							Số lượng </label>
						<div class="col-9">
				...
				<div class="col-9 m-3">
					<div class="row">
						<label for="DonGia" class="col-2 offset-1 col-form-label fw-bold">
							Đơn giá </label>
						<div class="col-9">
				...
				<div class="col-9 m-3">
					<div class="row">
						<label for="HinhAnh" class="col-2 offset-1 col-form-label fw-bold">
							Hình ảnh </label>
						<div class="col-9">
				...
				<div class="col-9 m-3">
					<div class="row">
						<label for="DonViTinh"
							class="col-2 offset-1 col-form-label fw-bold"> Đơn Vị
							Tính </label>
						<div class="col-9">
